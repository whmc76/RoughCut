...
function buildSettingsForm(config: NonNullable<ReturnType<typeof api.getConfig> extends Promise<infer T> ? T : never>): SettingsForm {
  return normalizeBundledForm({
    ...
    local_asr_api_base_url: config.local_asr_api_base_url,
    local_asr_model_name: config.local_asr_model_name,
    local_asr_display_name: config.local_asr_display_name,
    transcription_chunking_enabled: config.transcription_chunking_enabled,
    transcription_chunk_threshold_sec: config.transcription_chunk_threshold_sec,
    transcription_chunk_size_sec: config.transcription_chunk_size_sec,
    transcription_chunk_min_sec: config.transcription_chunk_min_sec,
    transcription_chunk_overlap_sec: config.transcription_chunk_overlap_sec,
    transcription_chunk_request_timeout_sec: config.transcription_chunk_request_timeout_sec,
    ...
    intelligent_copy_cover_image_generation_enabled: config.intelligent_copy_cover_image_generation_enabled,
    intelligent_copy_cover_image_backend: config.intelligent_copy_cover_image_backend,
    intelligent_copy_cover_image_model: config.intelligent_copy_cover_image_model,
    intelligent_copy_cover_image_quality: config.intelligent_copy_cover_image_quality,
    intelligent_copy_cover_image_timeout_sec: config.intelligent_copy_cover_image_timeout_sec,
    intelligent_copy_cover_codex_runner_model: config.intelligent_copy_cover_codex_runner_model,
    intelligent_copy_cover_codex_runner_effort: config.intelligent_copy_cover_codex_runner_effort,
