  ...
  return (
    <section className="page-stack">
      <PageHeader
        ...
        summary={[
          { label: "先定规则", value: "包装策略与导出参数", detail: "先把默认规则定清楚，再维护素材池" },
          { label: "再管素材", value: "片头、片尾、植入、音乐、水印", detail: "每类资产都在固定卡片内独立维护" },
          { label: "实际生效", value: "默认素材 + 素材池", detail: "单选控制默认素材，多选进入候选池" },
        ]}
      ...
      {config && (
        <>
          <PageSection
            eyebrow="规则"
            title="先确定包装策略"
            description="先把导出规则、植入方式、音乐逻辑和水印参数定稳，再去维护素材池。"
          >
          ...
          <PageSection
            eyebrow="素材"
            title="再维护包装素材池"
            description="每类素材都独立维护，单项默认素材和可轮播素材池分开管理，减少误选。"
          >
