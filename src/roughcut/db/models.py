...
class WatchRoot(Base):
    ...
    job_flow_mode: Mapped[str] = mapped_column(Text, nullable=False, default="auto", server_default="auto")
    edit_mode: Mapped[str] = mapped_column(Text, nullable=False, default="auto", server_default="auto")
    automation_level: Mapped[str] = mapped_column(Text, nullable=False, default="standard", server_default="standard")
    material_usage: Mapped[str] = mapped_column(Text, nullable=False, default="all_uploaded", server_default="all_uploaded")
