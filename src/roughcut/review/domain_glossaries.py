...
_KNIFE_DOMESTIC_BRANDS: tuple[GlossaryTermLike, ...] = (
    ...
    {"correct_form": "呼和", "wrong_forms": [], "category": "knife_brand", "context_hint": "折刀品牌"},
)
...
_DOMAIN_TERM_LIBRARY: dict[str, tuple[GlossaryTermLike, ...]] = {
    "gear": (
        ...
        *_BAG_DOMESTIC_BRANDS,
        ...
        {"correct_form": "锆合金", "wrong_forms": ["告合金", "造合金"], "category": "gear_material", "context_hint": "EDC 材质"},
        {"correct_form": "钛合金", "wrong_forms": ["太合金"], "category": "gear_material", "context_hint": "EDC 材质"},
        ...
        {"correct_form": "缎面", "wrong_forms": [], "category": "visual", "context_hint": "表面质感"},
        {"correct_form": "缎面研磨", "wrong_forms": [], "category": "process", "context_hint": "表面处理工艺"},
    ...
    "knife": (
        *_KNIFE_DOMESTIC_BRANDS,
        ...
        {"correct_form": "锆合金", "wrong_forms": ["告合金", "造合金"], "category": "knife_material", "context_hint": "折刀柄材/材质"},
        {"correct_form": "钛合金", "wrong_forms": ["太合金"], "category": "knife_material", "context_hint": "折刀柄材/材质"},
        {"correct_form": "缎面", "wrong_forms": [], "category": "knife_finish", "context_hint": "刀具表面质感"},
        {"correct_form": "缎面研磨", "wrong_forms": [], "category": "knife_finish", "context_hint": "刀具表面处理工艺"},
    ),
    "flashlight": (
        *_FLASHLIGHT_DOMESTIC_BRANDS,
        ...
        {"correct_form": "月光档", "wrong_forms": [], "category": "flashlight", "context_hint": "手电亮度档位"},
        ...
        {"correct_form": "透镜", "wrong_forms": [], "category": "flashlight", "context_hint": "手电光学结构"},
        {"correct_form": "光杯", "wrong_forms": [], "category": "flashlight", "context_hint": "手电光学结构"},
        ...
        {"correct_form": "触发", "wrong_forms": [], "category": "flashlight", "context_hint": "手电功能触发描述"},
        {"correct_form": "尾绳孔", "wrong_forms": ["背针孔"], "category": "flashlight", "context_hint": "手电结构"},
        {"correct_form": "绳孔", "wrong_forms": ["针孔"], "category": "flashlight", "context_hint": "手电结构"},
        {"correct_form": "胶塞儿", "wrong_forms": ["胶丝"], "category": "flashlight", "context_hint": "手电配件口语"},
        {"correct_form": "微弧版", "wrong_forms": ["V湖眼版", "V湖版", "V湖的"], "category": "flashlight", "context_hint": "手电版本称呼"},
    ...
    "bag": (
        *_BAG_DOMESTIC_BRANDS,
        ...
        {"correct_form": "FIDLOCK", "wrong_forms": ["Fidlock", "FID Lock", "FID lock"], "category": "bag_hardware", "context_hint": "机能包磁吸扣具"},
        {"correct_form": "磁扣", "wrong_forms": [], "category": "bag_hardware", "context_hint": "机能包扣具结构"},
...
_DOMAIN_KEYWORDS: dict[str, tuple[str, ...]] = {
    "gear": (
        ...
        "RUIKE", "SANRENMU", "KIZER", "WE Knife", "CIVIVI", "BESTECH", "KUBEY", "REAL STEEL", "CJRB", "ARTISAN CUTLERY", "MAXACE", "MUNDUS", "MICROTECH", "呼和",
        "tomtoc", "PGYTECH", "NIID", "COMBACK", "MADEN", "LEVEL8", "狐蝠工业", "头狼工业", "BOLTBOAT", "PSIGEAR", "LIIGEAR",
        "顶配", "次顶配", "标配", "高配", "低配", "钢马", "锆马", "钛马", "铜马", "大马", "大马士革",
        "镜面", "雾面", "缎面", "缎面研磨", "潮玩", "盲盒", "隐藏款", "官图", "原型", "涂装", "素体", "关节", "可动", "盒损", "手办",
        "户外", "战术", "露营", "徒步", "营地", "快挂", "鞘套", "战术笔", "K鞘", "四百号", "即EDC", "如假包换",
    ),
    "edc": ("EDC", "FAS", "NOC", "REATE", "LEATHERMAN", "OLIGHT", "ZIPPO", "FENIX", "NITECORE", "NEXTORCH", "ACEBEAM", "LOOPGEAR", "SUPFIRE", "JETBEAM", "KLARUS", "WUBEN", "NexTool", "SATA", "LAOA", "WORKPRO", "SOG", "WARNA", "SQT顺全作", "GERBER", "RUIKE", "SANRENMU", "KIZER", "WE Knife", "CIVIVI", "BESTECH", "KUBEY", "REAL STEEL", "CJRB", "ARTISAN CUTLERY", "MAXACE", "MUNDUS", "MICROTECH", "呼和", "tomtoc", "PGYTECH", "NIID", "COMBACK", "MADEN", "LEVEL8", "狐蝠工业", "头狼工业", "BOLTBOAT", "PSIGEAR", "LIIGEAR", "折刀", "刀", "钛", "柄材", "钢材", "背夹", "工具钳", "彩雕", "深雕", "顶配", "次顶配", "标配", "高配", "低配", "钢马", "锆马", "钛马", "铜马", "大马", "大马士革", "镜面", "雾面", "缎面", "缎面研磨", "K鞘", "四百号", "即EDC"),
    ...
    "food": (
        ...
        "咀嚼", "嚼", "samplemint", "samplepod", "sampleport",
    ),
    ...
    "knife": ("折刀", "主刀", "副刀", "锁定", "开合", "背夹", "刃型", "柄材", "钢材", "轴锁", "线锁", "缎面", "缎面研磨", "NOC", "RUIKE", "SANRENMU", "KIZER", "WE Knife", "CIVIVI", "BESTECH", "KUBEY", "REAL STEEL", "CJRB", "ARTISAN CUTLERY", "MAXACE", "MUNDUS", "MICROTECH", "呼和"),
    "flashlight": ("手电", "手电评测", "内置电池", "月光档", "灯珠", "透镜", "光杯", "色温", "泛光", "聚光", "流明", "筒身", "尾按", "尾绳孔", "绳孔", "胶塞儿", "微弧版", "微弧氧化版", "UV", "FENIX", "NITECORE", "NEXTORCH", "ACEBEAM", "LOOPGEAR", "SUPFIRE", "JETBEAM", "KLARUS", "WUBEN", "NexTool"),
    "bag": ("机能包", "FIDLOCK", "磁扣", "双肩包", "通勤包", "斜挎包", "胸包", "快取包", "收纳包", "小副包", "阵风", "游刃", "FXX1", "FXX1小副包", "tomtoc", "PGYTECH", "NIID", "COMBACK", "MADEN", "LEVEL8", "狐蝠工业", "头狼工业", "BOLTBOAT", "PSIGEAR", "LIIGEAR"),
