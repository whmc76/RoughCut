...
@click.group()
def cli():
    """FastCut — Automated video editing & subtitle review."""
...
def orchestrator(poll_interval: float):
    ...
    from fastcut.pipeline.orchestrator import run_orchestrator
...
def watcher(path: str, channel_profile: str | None, language: str):
    ...
    from fastcut.watcher.folder_watcher import watch_directory
