...
def test_rule_registry_exposes_llm_review_gate_and_risk_normalization() -> None:
    ...
    assert rule_auto_applies_in_auto_mode("failed_attempt", risk_level="high") is False
    assert rule_requires_llm_review("off_topic_interruption", risk_level="high") is True
